...
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 ...
 0 0 outWrt'                 Slope angle: ',(fmtAmt slope_angle),' deegrees'
 0 0 outWrt'Wall cover by roof (outdoor): ',(fmtAmt slope_wall_cover_length×length_si_2_rep_unit),' ',length_rep_unit_txt
 0 0 outWrt'  Roof wall to wall distance: ',(fmtAmt roof_house_w_cover_length×length_si_2_rep_unit),' ',length_rep_unit_txt

⍝_________________________
⍝ ... Calculate geometry of roof elements
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 1 1 outWrt'Calculating slope geometry...'
 ...
 0 0 outWrt'          Slope total length: ',(fmtAmt slope_length×length_si_2_rep_unit),' ',length_rep_unit_txt
 0 0 outWrt'     Slope wall cover length: ',(fmtAmt slope_wall_cover_act_length×length_si_2_rep_unit),' ',length_rep_unit_txt
...
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 ...
 1 1 outWrt'Check roof drawing: ⍝ drawing'
...
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 ...
 1 outWrt'Collecting load (Q) on the roof generated by different sources...'
 outWrt'             Snow: ',(fmtAmt 3 rnd Qs×Q_si_to_rep),' ',Q_rep_units_txt
 outWrt'             Wind: ',(fmtAmt 3 rnd Qw×Q_si_to_rep),' ',Q_rep_units_txt
 outWrt'       Roof cover: ',(fmtAmt 3 rnd Qrc×Q_si_to_rep),' ',Q_rep_units_txt
 outWrt'  Roof insulation: ',(fmtAmt 3 rnd Qri×Q_si_to_rep),' ',Q_rep_units_txt
 outWrt' Roof rafter mass: ',(fmtAmt 3 rnd Qrr×Q_si_to_rep),' ',Q_rep_units_txt
 1 1 outWrt'   Total load: ',(fmtAmt 3 rnd Q×Q_si_to_rep),' ',Q_rep_units_txt

⍝_________________________
⍝ ... Calculate forces applied on roof slope
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 0 1 outWrt'Calculate forces applied on roof slope...'
 F_rep_units_txt←'kg'
 F_si_to_rep←Q_si_to_rep
 Qn←Q×cos(slope_angle)
 Qt←Q×sin(slope_angle)

 outWrt'           Slope normal load (Qn): ',(fmtAmt 3 rnd Qn×Q_si_to_rep),' ',Q_rep_units_txt
 outWrt'          Slope tensile load (Qt): ',(fmtAmt 3 rnd Qt×Q_si_to_rep),' ',Q_rep_units_txt

 w←(1+0.5×((cos(slope_angle))power 2))
 Fn←Q×slope_length×cos(slope_angle)
 Ft←Q×slope_length×sin(slope_angle)

 outWrt'    Slope normal total force (Fn): ',(fmtAmt 3 rnd Fn×F_si_to_rep),' ',F_rep_units_txt
 outWrt'   Slope tensile total force (Ft): ',(fmtAmt 3 rnd Ft×F_si_to_rep),' ',F_rep_units_txt
 ...
 0 1 outWrt'Slope max benting momentum (Mmax): ',(fmtAmt 3 rnd Mmax×M_si_to_rep),' ',M_rep_units_txt

⍝_________________________
⍝ ... Define criteria of roof mechanical stability
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 bent_ratio←1÷200
 0 1 outWrt'    Roof rafter benting limit is: L÷',fmtAmt 3 rnd(bent_ratio power ¯1)

⍝_________________________
⍝ ... Calculate optimal rafter geometry
⍝¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
 0 1 outWrt'Calculate optimal geometry of the roof rafter...'
 b←50÷1000         ⍝ ... Standard Rafter width, espressed in SI units, m
 h←150÷1000        ⍝ ... Standard Rafter height, m
 ...
 0 0 outWrt'       Roof rafter standard  width: ',(fmtAmt 3 rnd(b×length_si_2_rep_unit)),' ',length_rep_unit_txt
 0 0 outWrt'       Roof rafter standard height: ',(fmtAmt 3 rnd(h×length_si_2_rep_unit)),' ',length_rep_unit_txt
 0 0 outWrt'              Roof rafter material: ',E_material_txt
 0 0 outWrt'   Roof rafter elastic modulus (E): ',(fmtAmt 3 rnd(E×E_rep_si_fact)),' ',E_rep_units_txt
 0 0 outWrt'     Roof rafter max benting angle: ',(fmtAmt 3 rnd(bent_ang)),' ',Angle_rep_units_txt
 ...
 0 0 outWrt'Rafters maximal momentum of resistance to the maximum benting (Mr): ',(fmtAmt 3 rnd Mr×M_si_to_rep),' ',M_rep_units_txt
 Km_rel←Mr÷Mmax
 Km_abs←Km_rel-1
 K_rep_units_txt←'%'
 K_si2ru_fact←100
 :If Mr<Mmax
     1 1 outWrt'[ROOF can CRASH]: Standard rafter can crash as resistance momentum is less than benting maximum momentum induced by total roof load!'
 :Else
     1 1 outWrt'    [ROOF is OK]: Standard rafter can handle total roof load as resistance momentum is more than benting maximum momentum induced by the load...'
 :EndIf
 0 0 outWrt'                  Rafters resistance momentum margin (Kr): abs=',(fmtAmt 3 rnd Km_abs×K_si2ru_fact),' ',K_rep_units_txt,', rel=',(fmtAmt 3 rnd Km_rel×K_si2ru_fact),' ',K_rep_units_txt

 1 1 outWrt'Calculate optimal height of the roof rafter...'
 h←2×(Mmax÷(b×E×tan(bent_ang)))power 0.5
 0 0 outWrt'       Roof rafter optimal height (it will resist to the load, benting to the allowed maximum): ',(fmtAmt 1 rnd(h×length_si_2_rep_unit)),' ',length_rep_unit_txt
